...
func loadEchoRoutes(m *minima.Minima, routes []*Route) {
...
func MinimaHandler(method, path string) minima.Handler {
	return func(res *minima.Response, Request *minima.Request) {
		res.OK().Send("OK")
	}
}
